...
const NameAndAvatar = async ({
  ...
  return (
    <div className="w-[90vw] max-w-[800px] h-32 pl-4 pr-2 mx-auto mt-14 flex justify-between items-center border-b-8 border-main rounded-lg underline-offset-8 bg-secondary">
